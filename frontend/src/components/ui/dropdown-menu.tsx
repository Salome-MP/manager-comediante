...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-overlay-medium -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-overlay-medium focus:text-foreground data-[state=open]:bg-overlay-medium data-[state=open]:text-foreground",
        "[&_svg:not([class*='text-'])]:text-muted-foreground",
